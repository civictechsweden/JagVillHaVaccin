import sys
sys.path.append('/Users/anabulascruz/github/JagVillHaVaccin/')
...
def make_maps(info_centres: dict):
    ...
    with open(CSV_POP_URL, 'r') as file:
        csv_pop = csv.DictReader(file, delimiter=';')
        # get_csv(CSV_POP_URL, header=True, delimiter=";")
...
def main():
    ...
    print(JSON_INFO_CENTRES_URL)
    with open('data/output/info_centres.json') as jsonFile:
        info_centres = json.load(jsonFile)
